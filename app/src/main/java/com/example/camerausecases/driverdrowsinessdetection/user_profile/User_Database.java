...
@Database(entities = {User_Profile.class}, version = 1)
public abstract  class User_Database extends RoomDatabase{
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    User_Database.class, "user_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        PopulateDbAsyncTask(User_Database instance) {
            User_Dao dao = instance.User_Dao();
        }
        @Override
